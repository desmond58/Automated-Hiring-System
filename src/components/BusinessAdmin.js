  ...
  return (
    <form onSubmit={submitHandler}>
      ...
      <p>Do you have a driver's license and be able to travel if needed?</p>
          <MDBRadio name="flexRadioDefault" id="flexRadioDefault1" label="Yes" inline defaultChecked/>
          <MDBRadio name="flexRadioDefault" id="flexRadioDefault1" label="No" inline defaultChecked/>
