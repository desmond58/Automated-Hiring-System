    ...
    <form onSubmit={submitHandler}>
      ...
      <div className='pageContainer'>
        <div className='formContainer'>
          ...
          <div className='formBorder'>
            <div className='pageContainer'>
              <label htmlFor="availability" className="block font-bold mb-2"><b>Able to work on weekends and public holidays if required</b></label><br></br>
              <MDBRadio name="availability" id="flexRadioDefault1" label="Yes" />
              <MDBRadio name="availability" id="flexRadioDefault1" label="No" />
            </div>
          </div>
          ...
          <div className='formBorder'>
            <div className='pageContainer'>
              <label htmlFor="input2" className="block font-bold mb-2">
                <b>How are your organizational skills? </b>        </label>
              <MDBTextArea
          ...
          <div className='formBorder'>
            <div className='pageContainer'>
              <label htmlFor="input3" className="block font-bold mb-2">
                <b>Do you have the ability to multitask? How would you multitask?  </b>      </label>
              <MDBTextArea
                style={{ display: "block", marginLeft: "auto", marginRight: "auto" }}
                rows={5}
                type="text"
          ...
          <div className='formBorder'>
            <div className='pageContainer'>
              <label htmlFor="input4" className="block font-bold mb-2">
                <b>How strong are your communication skills?</b>
              </label>
              <MDBTextArea
                style={{ display: "block", marginLeft: "auto", marginRight: "auto" }}
                rows={5}
          ...
          <div className='formBorder'>
            <div className='pageContainer'>
              <label htmlFor="input5" className="block font-bold mb-2">
                <b>How will you handle confidential information?</b>        </label>
              <MDBTextArea
                style={{ display: "block", marginLeft: "auto", marginRight: "auto" }}
                rows={5}
                type="text"
          ...
          <div className='formBorder'>
            <div className='pageContainer'>
              <label htmlFor="input6" className="block font-bold mb-2">
                <b>What do think are the key responsibilities for Admin Executive?</b>
              </label>
              <MDBTextArea
                style={{ display: "block", marginLeft: "auto", marginRight: "auto" }}
                rows={5}
          ...
          <div className='formBorder'>
            <div className='pageContainer'>
              <label htmlFor="input6" className="block font-bold mb-2">
               <b>How will you organize a meeting? What actions will you take?</b>        </label>
              <MDBTextArea
                style={{ display: "block", marginLeft: "auto", marginRight: "auto" }}
                rows={5}
                type="text"
