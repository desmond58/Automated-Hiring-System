    ...
    <form onSubmit={submitHandler}>
      ...
      <div className='pageContainer'>
        <div className='formContainer'>
          ...
          <div className='formBorder'>
            <div className='pageContainer'>
              <label htmlFor="academic" className="block font-bold mb-2"><b>Academic qualification in Accounting</b></label><br></br>
              <MDBRadio name="academic" id="flexRadioDefault1" label="LCCI" />
              <MDBRadio name="academic" id="flexRadioDefault1" label="ACCA" />
          ...
          <div className='formBorder'>
            <div className='pageContainer'>
              <label htmlFor="input2" className="block font-bold mb-2">
                <b>Do you have experience balancing multiple projects at the same time during studies?</b>
              </label>
              <MDBTextArea
          ...
          <div className='formBorder'>
            <div className='pageContainer'>
              <label htmlFor="input3" className="block font-bold mb-2">
                <b>Would you describe yourself as a detailed-oriented person?</b>
              </label>
              <MDBTextArea
                style={{ display: "block", marginLeft: "auto", marginRight: "auto" }}
                rows={5}
          ...
          <div className='formBorder'>
            <div className='pageContainer'>
              <label htmlFor="input4" className="block font-bold mb-2">
                <b>What qualities are most critical for Accounting?</b>
              </label>
              <MDBTextArea
                style={{ display: "block", marginLeft: "auto", marginRight: "auto" }}
                rows={5}
          ...
          <div className='formBorder'>
            <div className='pageContainer'>
              <label htmlFor="input5" className="block font-bold mb-2">
                <b>What tasks do you think accounting perform on a daily basis?</b>        </label>
              <MDBTextArea
                style={{ display: "block", marginLeft: "auto", marginRight: "auto" }}
                rows={5}
                type="text"
          ...
          <div className='formBorder'>
            <div className='pageContainer'>
              <label htmlFor="input6" className="block font-bold mb-2">
                <b>Are you good at working in a team as an accounting? </b>       </label>
              <MDBTextArea
                style={{ display: "block", marginLeft: "auto", marginRight: "auto" }}
                rows={5}
                type="text"
